...
const QuestionContent = ({ question, onChange, userAnswers, onChangeTextAnswer }) => {
    ...
    <Container column flex>
      ...
      <Row displayFlex style={{ ...questionAnswerPadding }}>
        <Column flex>
          ...
          <CheckboxGroup choices={question.categories} onChange={onChange} userAnswers={userAnswers}
                         pincites={false} />}
