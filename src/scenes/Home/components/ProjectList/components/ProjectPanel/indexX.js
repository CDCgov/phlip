...
export class ProjectPanel extends Component {
    ...
    render() {
      ...
      const generateKeyAndId = commonHelpers.generateUniqueProps(this.props.id)
      ...
      return (
        <ClickAwayListener onClickAway={handleClickAway}>
          <ExpansionPanel expanded={this.state.cardExpanded=== this.props.project.id} key={this.props.project.id}>
