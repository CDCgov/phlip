  ...
  test('should handle ADD_PROJECT_JURISDICTION_SUCCESS', () => {
    expect(
      reducer(
        ...
        }, { type: types.ADD_PROJECT_JURISDICTION_SUCCESS, payload: { id: 2, name: 'Jurisdiction 2' } }
      )
    ).toEqual({
      ...INITIAL_STATE,
      jurisdictions: {
  ...
  test('should handle UPDATE_JURISDICTION_SEARCH_VALUE', () => {
    expect(
      reducer(
        ...
        }, { type: types.UPDATE_JURISDICTION_SEARCH_VALUE, searchValue: 'O' }
      )
    ).toEqual({
      ...INITIAL_STATE,
      jurisdictions: {
      ...
      reducer(
        {
          ...INITIAL_STATE,
          suggestionValue: ''
        }, { type: types.UPDATE_SUGGESTION_VALUE, suggestionValue: 'O' }
      )
    ).toEqual({
      ...INITIAL_STATE,
      suggestionValue: 'O',
