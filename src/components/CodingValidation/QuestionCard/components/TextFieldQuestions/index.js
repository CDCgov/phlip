...
export const TextFieldQuestions = ({ mergedUserQuestions, validatorAnswer, onChange, answerId, currentUserInitials, style }) => {
  return (
    <Fragment>
      ...
      <InputBox
        ...
        value={validatorAnswer} answerId={answerId} currentUserInitials={currentUserInitials} isValidation={true}
      />
    </Fragment>
  )
}
